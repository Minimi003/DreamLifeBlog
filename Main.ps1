...
$sourcePath = "D:\doc\Obsidian\Home\Blog"
$destinationPath = "C:\Users\Michel\Documents\DreamLifeBlog\content\posts"

# Set Github repo 
$myrepo = "git@github.com:Minimi003/DreamLifeBlog.git"
